...
namespace pzd.lib.reactive {
  [PublicAPI] public interface ISubscription : IDisposable {
    bool isSubscribed { get; }
    bool unsubscribe();
  }

  [PublicAPI] public static class ISubscriptionExts {
  ...
  [PublicAPI] public class Subscription : ISubscription {
